...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="<?= base_url('mata-pelajaran/store') ?>">
                <?= csrf_field() ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_mapel" id="nama_mapel" value="<?= old('nama_mapel') ?>" placeholder="Masukkan Nama Mapel"
