        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= base_url('tahun-ajaran/update/' . $tahun_ajaran['id']) ?>">
                        <?= csrf_field() ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tahun_ajaran" id="tahun_ajaran" value="<?= old('tahun_ajaran', $tahun_ajaran['tahun_ajaran']) ?>" placeholder="Masukkan Tahun Ajaran"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="mulai" id="mulai" value="<?= old('mulai', $tahun_ajaran['mulai']) ?>" placeholder="Masukkan Mulai"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="selesai" id="selesai" value="<?= old('selesai', $tahun_ajaran['selesai']) ?>" placeholder="Masukkan Mulai"
