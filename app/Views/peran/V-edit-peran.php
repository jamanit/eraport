...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="<?= base_url('peran/update/' . $peran['id']) ?>">
                <?= csrf_field() ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_peran" id="nama_peran" value="<?= old('nama_peran', $peran['nama_peran']) ?>" placeholder="Masukkan Nama Peran"
