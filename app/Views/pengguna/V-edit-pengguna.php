...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="<?= base_url('pengguna/update/' . $pengguna['id']) ?>">
                <?= csrf_field() ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" id="nama" value="<?= old('nama', $pengguna['nama']) ?>" placeholder="Masukkan Nama"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" value="<?= old('email', $pengguna['email']) ?>" placeholder=" Masukkan Email"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_peran" id="id_peran" class="form-control <?= isset($errors['id_peran']) ? 'is-invalid' : '' ?>">
                                        ...
                                        <?php foreach ($peran as $item): ?>
                                            <option value="<?= $item['id'] ?>" <?= old('id_peran', $pengguna['id_peran']) == $item['id'] ? 'selected' : '' ?>><?= $item['nama_peran'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                                        <?= $errors['id_peran'] ?? '' ?>
