                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="id_tahun_ajaran" id="id_tahun_ajaran" class="form-control <?= isset($errors['id_tahun_ajaran']) ? 'is-invalid' : '' ?> select2">
                                        ...
                                        <?php foreach ($tahun_ajaran as $item): ?>
                                            <option value="<?= $item['id'] ?>" <?= old('id_tahun_ajaran', $kelas['id_tahun_ajaran']) == $item['id'] ? 'selected' : '' ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kelas" id="nama_kelas" value="<?= old('nama_kelas', $kelas['nama_kelas']) ?>" placeholder="Masukkan Nama kelas"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_guru_wali" id="id_guru_wali" class="form-control <?= isset($errors['id_guru_wali']) ? 'is-invalid' : '' ?> select2">
                                        ...
                                        <?php foreach ($pengguna as $item): ?>
                                            <option value="<?= $item['id'] ?>" <?= old('id_guru_wali', $kelas['id_guru_wali']) == $item['id'] ? 'selected' : '' ?>><?= $item['nama'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                                        <?= $errors['id_guru_wali'] ?? '' ?>
