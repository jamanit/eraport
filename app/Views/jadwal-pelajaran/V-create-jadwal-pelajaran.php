...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="<?= base_url('jadwal-pelajaran/store') ?>">
                <?= csrf_field() ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_mapel" id="id_mapel" class="form-control <?= isset($errors['id_mapel']) ? 'is-invalid' : '' ?> select2">
                                        ...
                                        <?php foreach ($mapel as $item): ?>
                                            <option value="<?= $item['id'] ?>" <?= old('id_mapel') == $item['id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jam_ke" id="jam_ke" class="form-control <?= isset($errors['jam_ke']) ? 'is-invalid' : '' ?> select2">
                                        <option value="">Pilih</option>
                                        <option value="1" <?= old('jam_ke') == '1' ? 'selected' : '' ?>>1</option>
                                        <option value="2" <?= old('jam_ke') == '2' ? 'selected' : '' ?>>2</option>
                                        <option value="3" <?= old('jam_ke') == '3' ? 'selected' : '' ?>>3</option>
                                        <option value="4" <?= old('jam_ke') == '4' ? 'selected' : '' ?>>4</option>
                                    </select>
                                    <div class="invalid-feedback">
                                        <?= $errors['jam_ke'] ?? '' ?>
                                    </div>
