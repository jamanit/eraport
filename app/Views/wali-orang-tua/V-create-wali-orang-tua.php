...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="<?= base_url('wali-orang-tua/store') ?>">
                <?= csrf_field() ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_wali" id="nama_wali" value="<?= old('nama_wali') ?>" placeholder="Masukkan Nama Wali"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="hubungan" id="hubungan" value="<?= old('hubungan') ?>" placeholder="Masukkan Hubungan"
