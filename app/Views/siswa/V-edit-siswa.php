                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nisn" id="nisn" value="<?= old('nisn', $siswa['nisn']) ?>" placeholder="Masukkan NISN"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_siswa" id="nama_siswa" value="<?= old('nama_siswa', $siswa['nama_siswa']) ?>" placeholder="Masukkan Nama Siswa"
